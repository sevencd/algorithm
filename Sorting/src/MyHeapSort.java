 ...
 */
public class MyHeapSort extends Constant {

    private static long time = 0l;
    private static long time2 = 0l;

    public static void main(String[] args) throws Exception {
        Constant.printResult(new MyHeapSort().sort(Constant.array, Constant.len));
        Constant.printResult(new MyHeapSort().sort2(Constant.array, Constant.len));
